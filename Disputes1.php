...
if($_SESSION["userID"] != $txtcustomerEmail or !is_array($row))
{   

    echo '<script type="text/javascript">';
    echo  'alert("Kindly input the email you registered with");';
    echo 'window.location.replace("http://localhost/Disputes.php");';
    echo "</script>";
}
...
$sql = "INSERT INTO dispute (ref_num, subjects,ref_type, administrator_id, customer_id) VALUES ('$finalresult', '$txtDisSubject','$txtDescription', null, '$txtcustomerEmail')";
